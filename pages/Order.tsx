                    ...
                    <AnimatePresence mode="wait">
                      {hasPersonalDomain ? (
                        ...
                        <motion.div key="no-domain-msg" initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} className="overflow-hidden">
                          <p className="text-[11px] text-slate-500 font-medium italic p-4 bg-slate-950 rounded-2xl border border-white/5">Note: Without a domain, we use a shared sub-link (yourname.netlify.app). Custom domains are recommended for better branding.</p>
                        </motion.div>
                      )}
                    </AnimatePresence>
                  </motion.div>
